...
const Experience = (props) => (
	<section id={ESection.experience} className={classes.AboutMe}>
		{/* TODO <img></img> */}
		<div className={classes.JohnDola}>
			...
			<p>
				nulla laborum labore ipsum veniam consectetur voluptate dolore sunt est. Officia deserunt sint ex sunt
