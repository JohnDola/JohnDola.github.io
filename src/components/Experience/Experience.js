...
const Experience = (props) => {
	const tracks = [
		{
			...
			location: 'St. Georgen',
			description: `Nisi ex sit minim magna duis duis fugiat consectetur 
			...
			responsibilities: [ 'JavaScript/TypeScript', 'HTML/CSS', 'ExtJS', 'ExtReact', 'C#', 'CefSharp', 'Cordova' ],
			experiences: [ 'Great Job in reputable company', 'interesting projects' ]
		},
		{
			title: 'Full Stack Angular C# Web Developer',
			location: 'St. Georgen',
			description: `Nisi ex sit minim magna duis duis fugiat consectetur 
                culpa labore ullamco dolore. Id exercitation dolor
                 est sint proident aliquip ex reprehenderit anim veniam Lorem. Duis consectetur 
	...
	return (
		<section id={ESection.experience} className={classes.Experience}>
			{/* TODO <img></img> */}
			<h2>Experience</h2>
			{tracks.map((track, index) => <ExperienceTrack key={index} {...track} />)}
		</section>
	);
};
